  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex items-center pt-24 pb-8 lg:pt-20 lg:pb-0">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-white dark:bg-slate-950 z-10 opacity-70 dark:opacity-80" />
        <motion.img
        ...
        <div className="absolute bottom-[-10%] left-[-5%] w-[250px] h-[250px] md:w-[400px] md:h-[400px] bg-black/5 dark:bg-white/5 rounded-full blur-[70px] md:blur-[100px]" />
      </div>
      <HeroCodeBackground tone={resolvedTheme === 'dark' ? 'dark' : 'light'} />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-3/5 flex flex-col items-start gap-8 lg:gap-10">
            ...
            <motion.h1 
              ...
              className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-slate-900 dark:text-white leading-[0.85] md:leading-[0.8] tracking-tighter uppercase italic"
            >
              <span
                ...
                className={`inline-block cursor-pointer transition-colors duration-300 ${
                  hoveredHeadlinePart ? 'text-[#ffb400]' : 'text-slate-900 dark:text-white'
                }`}
              >
                WE CODE
              </span>{' '}
              ...
              <span
                ...
                className={`inline-block cursor-pointer not-italic transition-colors duration-300 ${
                  hoveredHeadlinePart ? 'text-black dark:text-white' : 'text-[#ffb400]'
                }`}
              >
                EXCELLENCE.
              </span>
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-slate-500 dark:text-zinc-400 max-w-xl leading-relaxed font-medium"
            >
          ...
          >
            ...
            <div className="relative z-10 aspect-[4/5] rounded-[40px] md:rounded-[60px] overflow-hidden border-[10px] md:border-[16px] border-white dark:border-zinc-900 shadow-3xl bg-slate-100 dark:bg-zinc-900 group">
               <motion.img 
            ...
            <motion.div 
              ...
              className="absolute -left-4 md:-left-12 bottom-10 md:bottom-20 bg-white dark:bg-zinc-900 p-5 md:p-8 rounded-[25px] md:rounded-[30px] shadow-2xl border border-slate-50 dark:border-zinc-800 z-20 hidden sm:flex items-center gap-3 md:gap-5"
            >
              ...
              <div>
                 <h4 className="text-slate-900 dark:text-white font-black text-base md:text-lg tracking-tighter">SYNTECHCRAFT</h4>
