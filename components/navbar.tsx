      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          ...
          <a
            ...
            className="flex items-center justify-center w-11 h-11 rounded-2xl bg-black text-white hover:bg-[#ffb400] hover:text-black transition-all shadow-xl shadow-black/10 hover:shadow-[#ffb400]/20"
            aria-label="WhatsApp"
          >
          ...
          >
            <div className="flex justify-between items-center mb-16">
              <Link href="#home" onClick={() => setIsOpen(false)} className="flex items-center gap-2 group">
                ...
                <span className="text-xl font-black text-slate-900 tracking-tighter italic uppercase whitespace-nowrap">
                  SYN <span className="text-[#ffb400] not-italic">TECHCRAFT</span>
                </span>
              </Link>
              <button 
                className="ml-4 -mr-2 w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center hover:bg-[#ffb400] transition-colors"
                onClick={() => setIsOpen(false)}
              >
                <X size={24} />
              </button>
